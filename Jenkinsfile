pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'PPSSPP_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-ppsspp'
    CONTAINER_NAME = 'ppsspp'
    DOCKERHUB_IMAGE = 'linuxserver/ppsspp'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/ppsspp'
    PR_DOCKERHUB_IMAGE = 'lspipepr/ppsspp'
    DIST_IMAGE = 'arch'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
  ...
  stages {
    ...
    stage("Set tag custom bash"){
      steps{
        script{
          env.EXT_RELEASE = sh(
            script: ''' curl -sL https://archlinux.org/packages/extra/x86_64/ppsspp/ |awk -F'(<h2>ppsspp |</h2>)' '/<h2>/ {print $2}' ''',
            returnStdout: true).trim()
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-ppsspp/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-ppsspp\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-ppsspp\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Ppsspp\" \
          --label \"org.opencontainers.image.description=[PPSSPP](https://www.ppsspp.org/) is a free and open-source PSP emulator for Windows, macOS, Linux, iOS, Android, Nintendo Wii U, Nintendo Switch, BlackBerry 10, MeeGo, Pandora, Xbox Series and Symbian with a focus on speed and portability.\" \
